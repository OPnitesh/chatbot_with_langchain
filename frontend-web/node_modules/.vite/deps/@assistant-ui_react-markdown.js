import {
  ...
  useCallbackRef,
  useMessagePartText
} from "./chunk-24OXWXOQ.js";
import "./chunk-L37ISP5B.js";
import {
  require_jsx_runtime
} from "./chunk-PY4NEHFQ.js";
import {
  __commonJS,
  __export,
  __publicField,
...
var memoizeMarkdownComponents = (components = {}) => {
  return Object.fromEntries(Object.entries(components ?? {}).map(([key, value]) => {
    ...
    const WithoutNode = ({ node: node2, ...props }) => {
...
var DefaultPre = ({ node: node2, ...rest }) => (0, import_jsx_runtime4.jsx)("pre", { ...rest });
var DefaultCode = ({ node: node2, ...rest }) => (0, import_jsx_runtime4.jsx)("code", { ...rest });
var DefaultCodeBlockContent = ({ node: node2, components: { Pre, Code }, code: code2 }) => (0, import_jsx_runtime4.jsx)(Pre, { children: (0, import_jsx_runtime4.jsx)(Code, { node: node2, children: code2 }) });
...
var DefaultCodeBlock = ({ node: node2, components: { Pre, Code, SyntaxHighlighter, CodeHeader }, language, code: code2 }) => {
  const components = (0, import_react4.useMemo)(() => ({ Pre, Code }), [Pre, Code]);
  const SH = language ? SyntaxHighlighter : DefaultCodeBlockContent;
  return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)(CodeHeader, { node: node2, language, code: code2 }), (0, import_jsx_runtime5.jsx)(SH, { node: node2, components, language: language ?? "unknown", code: code2 })] });
};
...
// node_modules/@assistant-ui/react-markdown/dist/overrides/CodeOverride.js
var CodeBlockOverride = ({ node: node2, components: { Pre, Code, SyntaxHighlighter: FallbackSyntaxHighlighter, CodeHeader: FallbackCodeHeader }, componentsByLanguage = {}, children, ...codeProps }) => {
  var _a, _b, _c;
  ...
  if (typeof children !== "string") {
    return (0, import_jsx_runtime6.jsx)(DefaultCodeBlockContent, { node: node2, components: { Pre: WrappedPre, Code: WrappedCode }, code: children });
  }
  ...
  return (0, import_jsx_runtime6.jsx)(DefaultCodeBlock, { node: node2, components: {
    Pre: WrappedPre,
    Code: WrappedCode,
    SyntaxHighlighter,
    CodeHeader
...
var CodeOverrideImpl = ({ node: node2, components, componentsByLanguage, ...props }) => {
  const isCodeBlock = useIsMarkdownCodeBlock();
  if (!isCodeBlock)
    return (0, import_jsx_runtime6.jsx)(components.Code, { ...props });
  return (0, import_jsx_runtime6.jsx)(CodeBlockOverride, { node: node2, components, componentsByLanguage, ...props });
};
