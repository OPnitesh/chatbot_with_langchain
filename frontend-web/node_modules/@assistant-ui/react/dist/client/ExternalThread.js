import { resource, tapState, tapMemo, tapEffect, tapEffectEvent, } from "@assistant-ui/tap";
import { tapClientLookup, attachDefaultPeers, tapClientResource, Derived, } from "@assistant-ui/store";
import { withKey } from "@assistant-ui/tap";
import { ModelContext } from "./ModelContextClient.js";
import { Tools } from "./Tools.js";
import { Suggestions } from "./Suggestions.js";
// Message Client - minimal implementation
const MessageClient = resource(({ message, index, onEdit, onReload, }) => {
...
const ComposerClientResource = resource(({ type, isEditing, canCancel, onCancel, onBeginEdit, onSend, message, }) => {
    ...
    const [quote, setQuote] = tapState(undefined);
...
export const ExternalThread = resource(({ messages, isRunning = false, onNew, onEdit, onReload, onStartRun, onCancel, }) => {
