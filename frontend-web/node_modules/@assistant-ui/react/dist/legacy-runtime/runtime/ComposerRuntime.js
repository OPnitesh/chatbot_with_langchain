...
import { EditComposerAttachmentRuntimeImpl, ThreadComposerAttachmentRuntimeImpl, } from "./AttachmentRuntime.js";
...
export class ComposerRuntimeImpl {
    _core;
    get path() {
...
export class ThreadComposerRuntimeImpl extends ComposerRuntimeImpl {
    get path() {
        return this._core.path;
    }
    get type() {
...
export class EditComposerRuntimeImpl extends ComposerRuntimeImpl {
    _beginEdit;
    get path() {
        return this._core.path;
    }
